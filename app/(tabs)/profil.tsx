...
function profil() {
  return (
    <>
       <ScrollView className="flex flex-col h-full mt-12">
      {/* Header */}
      <View className="bg-yellow-400 text-white text-center py-4">
      ...
      <View className="flex flex-col items-center bg-gray-100 py-6">
        <View className="flex items-center mb-4">
          ...
          <View className="ml-4">
            <Text className="text-lg font-bold">TIMOTIUS DWI YULIANTO MALAU</Text>
            <Text className="text-gray-600">timotiusdwimalau@students.unnes.ac.id</Text>
